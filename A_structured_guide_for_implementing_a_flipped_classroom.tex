...
\begin{flushleft}
{\Large
\textbf\newline{A structured guide for implementing a flipped classroom} 
}
\newline
...
\cite{casasola_can_2017, crouch_peer_2001, freeman_reply_2014}, including for students facing difficulties \cite{lage_inverting_2000}. %For the specific case of computational biology classes, Compeau has published detailed and positive feedback on this pedagogy \cite{compeau_establishing_2019}.
